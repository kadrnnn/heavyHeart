...
public class ValidateUtil {
    ...
    static boolean literal(String text) {
    ...
    static boolean aggregate(char entryCharacter, char exitCharacter,
                             boolean prefix) {
        if (c != entryCharacter)
            return false;
        nextCharacter();
    ...
    static boolean error(String type, int col) {
